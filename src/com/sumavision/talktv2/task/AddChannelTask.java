...
public class AddChannelTask extends AsyncTask<Object, Integer, Integer> {
	private NetConnectionListenerNew listener;
	private String method;
	private boolean isLoadMore;
	private String errMsg = null;
	private static final String TAG = "AddChannelTask";

	public AddChannelTask(NetConnectionListenerNew listener, boolean isLoadMore) {
		method = Constants.addChannelTask;
