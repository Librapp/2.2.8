...
public class AddRemindTask extends AsyncTask<Object, Integer, Integer> {
	private NetConnectionListenerNew listener;
	private String method;
	private boolean isLoadMore;
	private String errMsg = null;
	private static final String TAG = "AddRemindTask";

	public AddRemindTask(NetConnectionListenerNew listener, boolean isLoadMore) {
		method = Constants.remindAdd;
