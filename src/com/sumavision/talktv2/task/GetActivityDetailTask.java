 ...
 * @changLog
 */
public class GetActivityDetailTask extends AsyncTask<Object, Void, String> {
	private final String TAG = "GetActivityDetailTask";
	private final NetConnectionListener listener;
	private final String method = "activityDetail";

	public GetActivityDetailTask(NetConnectionListener listener) {
	...
	protected String doInBackground(Object... params) {
		Context context;
		ActivityDetailRequest request;
		String data;
		context = (Context) params[0];
		request = (ActivityDetailRequest) params[1];
		data = request.make();
