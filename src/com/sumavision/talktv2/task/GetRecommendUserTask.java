 ...
 * @changLog
 */
public class GetRecommendUserTask extends AsyncTask<Object, Void, String> {
	private final String TAG = "GetRecommendUserTask";
	private final NetConnectionListener listener;
	private final String method = "recommendUserList";

	public GetRecommendUserTask(NetConnectionListener listener) {
	...
	protected String doInBackground(Object... params) {
		Context context;
		RecommendUserListRequest request;
		RecommendUserListParser parser;
		String data;
		context = (Context) params[0];
		request = (RecommendUserListRequest) params[1];
		parser = (RecommendUserListParser) params[2];
		data = request.make();
