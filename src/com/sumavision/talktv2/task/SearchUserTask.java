 ...
 * @changLog
 */
public class SearchUserTask extends AsyncTask<Object, Void, String> {

	private final String TAG = "SearchUserTask";
	private final NetConnectionListener listener;
	private final String method = Constants.searchUser;

	public SearchUserTask(NetConnectionListener listener) {
	...
	protected String doInBackground(Object... params) {
		...
		request = (SearchUserRequest) params[1];
		parser = (SearchUserParser) params[2];
		data = request.make();
