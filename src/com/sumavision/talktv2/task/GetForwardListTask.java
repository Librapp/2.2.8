 ...
 * @changLog
 */
public class GetForwardListTask extends AsyncTask<Object, Void, String> {
	private final String TAG = "GetForwardListTask";
	private final NetConnectionListener listener;
	private final String method = "forwardList";

	public GetForwardListTask(NetConnectionListener listener) {
