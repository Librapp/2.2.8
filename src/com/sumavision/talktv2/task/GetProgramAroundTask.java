 ...
 * @version 2.2
 * @createTime 2012-1-5
 * @description 节目周边信息详情
 * @changeLog
 * 
 */

public class GetProgramAroundTask extends AsyncTask<Object, Void, String> {
	private final String TAG = "GetProgramAroundTask";
	private final NetConnectionListener listener;
	private final String method = "programAroundDetail";

	public GetProgramAroundTask(NetConnectionListener listener) {
	...
	protected String doInBackground(Object... params) {
		Context context;
		ProgramAroundRequest request;
		ProgramAroundParser parser;
		String data;
		context = (Context) params[0];
		request = (ProgramAroundRequest) params[1];
		parser = (ProgramAroundParser) params[2];
		data = request.make();
