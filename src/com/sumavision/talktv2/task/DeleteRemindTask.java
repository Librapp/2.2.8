...
public class DeleteRemindTask extends AsyncTask<Object, Integer, Integer> {
	private NetConnectionListenerNew listener;
	private String method;
	private boolean isLoadMore;
	private String errMsg = null;
	private static final String TAG = "DeleteRemindTask";

	public DeleteRemindTask(NetConnectionListenerNew listener,
			boolean isLoadMore) {
		method = Constants.remindDelete;
	...
	protected Integer doInBackground(Object... params) {
		...
		int programId = (Integer) params[2];
		String data = generateRequset(userId, programId);
		if (data != null) {
	 ...
	 * 
	 */
	private String generateRequset(int userId, int programId) {
		...
		try {
			...
			jsonObject.put("cpIds", programId);
