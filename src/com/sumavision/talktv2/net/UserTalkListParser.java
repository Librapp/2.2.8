 ...
 * @changLog
 */
public class UserTalkListParser extends JSONParser {
	...
	public String parse(String s) {
		...
		try {
			...
			if (errCode == JSONMessageType.SERVER_CODE_OK) {
				...
				// else
				// UserOther.current().talkCount = talkCount;
				...
				if (UserNow.current().isSelf)
					UserNow.current().setOwnComments(lc);
				// else
				// UserOther.current().setOwnComments(lc);
			} else
