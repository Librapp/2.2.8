...
public class Item {
	...
	/**
	 * @param mediumDrawable
	 *            the mediumDrawable to set
	 */
	...
	public Item(int id, String title, String artist, String album,
			String objectClass) {
		this.id = id;
		this.title = title;
		this.artist = artist;
	...
	public boolean equals(Object o) {
		if (o instanceof Item) {
			System.out.println(this.getTitle() + ":" + this.getId() + "=="
					+ ((Item) o).getId() + ":" + ((Item) o).getTitle());
